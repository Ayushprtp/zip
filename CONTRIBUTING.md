# Contributing to Flare.sh

Thank you for your interest in contributing to Flare.sh! We welcome contributions from the community and truly appreciate your effort to improve the project.
...
2. **Clone your fork** locally:
   ...
   ```bash
   git clone https://github.com/YOUR_USERNAME/flare.sh.git
   cd flare.sh
   ```
...
We sincerely appreciate your contribution to Flare.sh.
