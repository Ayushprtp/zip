...
import type { PermissionMode, PermissionPolicyConfig, PermissionRule } from '~/lib/agentic/types';
...
export const shortcutsStore = map<Shortcuts>({
  toggleTerminal: {
    ...
    ctrlOrMetaKey: true,
    action: () => {
      // Logic handled via shortcutEventEmitter in useShortcuts or Workbench
    },
  },
});
